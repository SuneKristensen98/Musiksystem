...
public class Factory {
	public TableColumn<TableViewInfo, String> columnFactoryString(String nameInClass, String columnName,
			double columnWidth) {
	...
	public TableColumn<TableViewInfo, Integer> columnFactoryInt(String nameInClass, String columnName,
			double columnWidth) {
	...
	public VBox vBoxFactory(int t, int r, int b, int l, Pos alignment) {
